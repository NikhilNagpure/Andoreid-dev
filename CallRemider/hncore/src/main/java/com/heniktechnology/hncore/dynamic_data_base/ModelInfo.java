...
import com.heniktechnology.hncore.dynamic_data_base.serializer.CalendarSerializer;
import com.heniktechnology.hncore.dynamic_data_base.serializer.FileSerializer;
import com.heniktechnology.hncore.dynamic_data_base.serializer.SqlDateSerializer;
import com.heniktechnology.hncore.dynamic_data_base.serializer.TypeSerializer;
import com.heniktechnology.hncore.dynamic_data_base.serializer.UtilDateSerializer;
	...
	public ModelInfo(Configuration configuration) {
		if (!loadModelFromMetaData(configuration)) {
			try {
				...
				HNLoger.error("Couldn't open source path.", e.toString());
			}
		}

		HNLoger.info("ModelInfo loaded.");
	}
		...
		if (typeSerializers != null) {
			for (Class<? extends TypeSerializer> typeSerializer : typeSerializers) {
				try {
					...
					HNLoger.error("Couldn't instantiate TypeSerializer.", e.toString());
				}
				catch (IllegalAccessException e) {
					HNLoger.error("IllegalAccessException", e.toString());
				}
			}
		}
	...
	private void scanForModelClasses(File path, String packageName, ClassLoader classLoader) {
		if (path.isDirectory()) {
			...
			try {
				...
				HNLoger.error("Couldn't create class.", e.toString());
			}
			catch (InstantiationException e) {
				HNLoger.error("Couldn't instantiate TypeSerializer.", e.toString());
			}
